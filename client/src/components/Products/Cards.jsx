		...
		<CardDeck>
			<Card>
				...
				<Card.Body>
					...
					<Card.Text>
						Capacity of 120 for cocktails or 75 for seated buffet gatheringss.
						Socialize around the antique bar or one of the vintage Jim Beam
						Whiskey Barrels. 1800 Sq.Ft.{" "}
						<ul>
				...
				<Card.Footer>
					<p style={{ textAlign: "center" }}>
						<Button variant='primary' onClick={() => {window.location.replace('/venue-rental')}}>Learn More</Button>
					</p>
				</Card.Footer>
			</Card>
			<Card>
				...
				<Card.Body>
					...
					<Card.Text>
						Looking for elegance and charm? Host your wedding, bridal shower?
						Find this cheery setting ideal for your birthday party or baby
						shower. Find Mockingbird Market ideal for even the most girlie-girl
						event. 1200 sq ft.{" "}
						<ul>
			...
			<Card>
				...
				<Card.Body>
					...
					<Card.Text>
						Our <stonrg>All Inclusive Package</stonrg> offers access to the
						Pesky Rabbit and Mockingbird Market plus use of the Garden, located
						in a private area adjoining the venue halls. This option also
						includes use of the property for a 2 hour photoshoot &amp; 1 hour
						meeting time which can be used for planning or rehearsal!
						<ul>

...
export default function index() {
  return (
    <Container style={{ marginBottom: '5rem', marginTop: '1rem', padding: '1rem', fontSize: 'small' }}>
      <Row>
        <Col xs={6}>
          <br /><br /><br />
          ...
          <p> Find all 6 historic murals...figure out which were added in the days of the Model T while others for movie sets. Enjoy exploring downtown!</p>

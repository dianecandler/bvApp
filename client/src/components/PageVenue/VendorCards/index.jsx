					...
					<Col>
						<div>
							<h2 style={{ paddingBottom: "1.5rem" }}>
								Explore how easy it is to shop local in Bartlett
							</h2>
							<CardDeck>
								<Card>
										...
										<Card.Text>
											...
											<ul>
												...
												<li>
													...
													<strong>
														<a
															href='https://www.facebook.com/Unique-Celebrations-154985771206579/'
															target='blank'
									...
									<Card.Body>
										...
										<Card.Text>
											...
											<ul>
												...
												<li>
													Opened 1904, operating as a bank until the 1930's
												</li>
											</ul>
										</Card.Text>
									</Card.Body>
									<Card.Img src={Bank3} alt='BnB' />
